...
```bash
git clone git@github.com:vasundhra-arulazi/air-quality-monitor.git
```
...
2. Copy the source from `src/air-quality-monitor.cpp` into the main source file for your Web IDE project.
